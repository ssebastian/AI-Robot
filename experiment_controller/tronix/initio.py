...
# This Method had been added by Sebastian Schmoll
def updateMotion(leftSpeed, rightSpeed):
    p.ChangeDutyCycle(leftSpeed if leftSpeed >= 0 else 0)
    q.ChangeDutyCycle(-leftSpeed if not leftSpeed >= 0 else 0)
    a.ChangeDutyCycle(rightSpeed if rightSpeed >= 0 else 0)
    b.ChangeDutyCycle(-rightSpeed if not rightSpeed >= 0 else 0)
    if leftSpeed >= 0: q.ChangeFrequency(leftSpeed + 5)
    else: p.ChangeFrequency(-leftSpeed + 5)
    if rightSpeed >= 0: a.ChangeFrequency(rightSpeed + 5)
    else: b.ChangeFrequency(-rightSpeed + 5)
